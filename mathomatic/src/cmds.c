...
#include "mathomatic/factor.h"
#include "mathomatic/factor_int.h"
#include "mathomatic/gcd.h"
#include "mathomatic/help.h"
#include "mathomatic/list.h"
#include "mathomatic/parse.h"
#include "mathomatic/poly.h"
#include "mathomatic/simplify.h"
#include "mathomatic/solve.h"
#include "mathomatic/super.h"
#include "mathomatic/unfactor.h"
#include <errno.h>
#include <ctype.h>
#include <math.h>
#include <stdlib.h>
...
char	*cp;
{
	...
	for (i1 = 0; i1 < vc; i1++) {
        ...
        n_tabs = list_var(va[i1].v, lang_code ? (int)lang_code : -5);
		if (lang_code) {
			if (strpbrk(var_str, "[]()"))
...
char	*cp;
{
    ...
    if (snprintf(buf, sizeof(buf), "%s.in", cp) >= (int)sizeof(buf)) {
