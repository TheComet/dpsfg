...
#include "mathomatic/blt.h"
#include "mathomatic/cmds.h"
#include "mathomatic/complex.h"
#include "mathomatic/diff.h"
#include "mathomatic/externs.h"
#include "mathomatic/help.h"
#include "mathomatic/integrate.h"
#include "mathomatic/license.h"	/* the current software license for Mathomatic */
#include "mathomatic/list.h"
#include "mathomatic/parse.h"
#include "mathomatic/simplify.h"
#include "mathomatic/solve.h"
#include <ctype.h>
#include <float.h>
#include <math.h>
#include <stdlib.h>
...
#define COMPARE_COMMAND_NAME(str)	(len >= min(CMD_REQUIRED_NCHARS, (int)strlen(str)) \
                                   && len <= (int)strlen(str) && strncasecmp(cp, str, len) == 0)
...
/* Copy the command-line to buf2 and use it, because the original string may be overwritten. */
            if (my_strlcpy(buf2, cp1, sizeof(buf2)) >= (int)sizeof(buf2)) {
