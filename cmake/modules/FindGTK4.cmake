if (GTK4_ROOT)
    set (_GTK4_LIB_PATH_HINTS
        "${GTK4_ROOT}/lib")
    set (_GTK4_INCLUDE_PATH_HINTS
        "${GTK4_ROOT}/include")
    set (_GTK4_BIN_PATH_HINTS
        "${GTK4_ROOT}/bin")
...
find_path (GTK4_pangocairo_INCLUDE_DIRS
...
find_library (GTK4_pango_LIBRARY
    NAMES "pango-1.0"
    PATHS ${_GTK4_LIB_PATH_HINTS})
find_library (GTK4_pangocairo_LIBRARY
...
foreach (_component IN LISTS GTK4_FIND_COMPONENTS)
    if (GTK4_${_component}_INCLUDE_DIRS AND GTK4_${_component}_LIBRARY)
        ...
        message (FATAL_ERROR "Failed to find GTK4 component ${_component}:\n"
            ...
            "  _GTK4_INCLUDE_PATH_HINTS: ${_GTK4_INCLUDE_PATH_HINTS}\n"
            "  _GTK4_LIB_PATH_HINTS: ${_GTK4_LIB_PATH_HINTS}\n"
            "  _GTK4_BIN_PATH_HINTS: ${_GTK4_BIN_PATH_HINTS}")
    endif ()
endforeach ()
